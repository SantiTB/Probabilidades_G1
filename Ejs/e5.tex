            ...
            \begin{enumerate}
                \item Sólamente ocurre $B$.\e\\
                    ...
                    \begin{center}
                        ...
                        \end{tikzpicture}
                    \end{center}
                    "Se obtiene ceca y 2 o cara y un primo mayor o igual a 3"\e
                \item Ocurren tanto $A$ como $B$ pero no ocurre $C$.
                    \begin{center}
                        \begin{tikzpicture}
                            [thick,
                            set/.style = {circle,
                ...
                \item Por lo menos dos ocurren.
                    \begin{center}
                        ...
                        \end{tikzpicture}
                    \end{center}
                    "cara con 2 o ceca con impares mayores o iguales a 3".
